...
class APsystemsStorageApiClient:
    ...
    async def async_get_data(
        self, endpoints: Sequence[str] | None = None
    ) -> dict[str, Any]:
        """Fetch data from the given GET endpoints.

        Args:
            endpoints: The endpoints to fetch. Defaults to all known endpoints.
        ...
        """
        data: dict[str, Any] = {}
        for endpoint in endpoints if endpoints is not None else GET_ENDPOINTS:
